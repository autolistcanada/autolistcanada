...
function selectTool(toolName) {
  ...
  elements.tiles.forEach(tile => tile.classList.remove('selected'));
  
  // Add selected class to clicked tile
  const selectedTile = document.querySelector(`.tile[data-tool="${toolName}"]`);
  if (selectedTile) {
...
function handleToolAction(toolName) {
  switch(toolName) {
    ...
    case 'guide':
      ...
      break;
    default:
      utils.showStatus('Tool not implemented yet', 'info');
  }
}
...
async function init() {
  try {
    ...
    // Listen for captured listings from background
    chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
      if (msg.action === "listingCapturedNotification") {
        showStatus(`New listing captured from ${msg.listing.platform}: ${msg.listing.title}`, 'success');
...
function updateSelectionStatus() {
  ...
  const text = count === 0 ? 'No listings selected' : 
               count === 1 ? '1 listing selected' : 
               `${count} listings selected`;
...
function openSyncSettings() {
  showStatus('Opening Sync Settings...', 'info');
  // In a real implementation, this would open the sync settings panel
  console.log('Sync Settings opened');
}

function openAIAssist() {
  showStatus('AI Assistant activated', 'success');
  // This would show the AI panel
  if (elements.aiPanel) {
    elements.aiPanel.classList.add('visible');
    state.showAiPanel = true;
  }
...
function openPlatformsManager() {
  showStatus('Opening Platforms Manager...', 'info');
  // In a real implementation, this would show the platforms management interface
  console.log('Platforms Manager opened');
}

function openConversionScore() {
  showStatus('Analyzing Conversion Score...', 'info');
  // In a real implementation, this would show conversion analytics
  console.log('Conversion Score analysis');
}

function openTagOptimizer() {
  showStatus('Opening Tag Optimizer...', 'info');
  // In a real implementation, this would open the tag optimization tool
  console.log('Tag Optimizer opened');
}

function openToneTrainer() {
  showStatus('Opening Tone Trainer...', 'info');
  // In a real implementation, this would open the tone training tool
  console.log('Tone Trainer opened');
}

function openTitleBuilder() {
  showStatus('Opening Title Builder...', 'info');
  // In a real implementation, this would open the title building tool
  console.log('Title Builder opened');
}

function openBulkEdit() {
  showStatus('Opening Bulk Edit...', 'info');
  // In a real implementation, this would open the bulk editing interface
  console.log('Bulk Edit opened');
}

function openGuide() {
  showStatus('Opening User Guide...', 'info');
  // In a real implementation, this would open the user guide
